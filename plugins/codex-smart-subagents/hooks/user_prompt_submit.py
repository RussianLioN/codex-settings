...
def handle(
    ...
    *,
    ...
    try:
        ...
        context = request_context(payload, config)
    ...
    text = (
        ...
        "Передавай только миссии, зависимости, оценки и выданные непрозрачные "
        "идентификаторы; не передавай пути, команды или переменные окружения. "
